...
<form method="POST"  action='banuser2.jsp'  name=frm onsubmit="return check()">

<br><br>

 <FONT  face="verdana" size=5 COLOR=black><center><b><u>Ban User</b></u></CENTER></font>
...
<td align = center>&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" src = 'images/ban.jpg'> </center></td>
</tr>
