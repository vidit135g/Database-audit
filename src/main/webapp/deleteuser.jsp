...
<form method="POST"  action='deleteuser2.jsp'  name=frm onsubmit="return check()">

<br><br>

 <FONT  face="verdana" size=5 COLOR=green><center><b><u>Delete User</b></u></CENTER></font>
...
<input type="image" src = 'images/delete2.jpg'> </td>
</tr>
